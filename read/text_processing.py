...
def loadAndTokenize(textFilePath,
    ...
    tokens, frequencyMap = convertToTokens(text, cleanHtml, ignoreCase, tokenizer, removeBlankTokens, skipSymbolSet,
                                           removeTokensContaining, keepNumbers, stopWordSet, tokenTransformFunction,
                                           stemmer)
