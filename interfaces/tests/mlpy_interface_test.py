...
def testMlpyHandmadeLogisticRegression():
	...
	ret = UML.trainAndApply("mlpy.LibLinear", trainingObj, trainY="Y", testX=testObj, output=None, arguments={"solver_type":"l2r_lr"})
...
def testMlpyHandmadeInnerProductTrainingPCA():
	...
	trainObj = Matrix(kernData)

	data2 = [[4,4]]
	kernData2 = mlpy.kernel_linear(data2, data2)
	testObj = Matrix(kernData2)
...
def testMlpyRegression():
	...
	ret = UML.trainAndApply("mlpy.ElasticNet", trainingObj, trainY="Y", testX=testObj, output=None, arguments={'lmb':.1, 'eps':.1})
	assert ret is not None
...
def testMlpyRequiredInitArgs():
	...
	ret = UML.trainAndApply("mlpy.ElasticNet", trainingObj, trainY="Y", testX=testObj, output=None, arguments={'lmb':1, 'eps':1})
	assert ret is not None
	ret = UML.trainAndApply("mlpy.ElasticNetC", trainingObj, trainY="Y", testX=testObj, output=None, arguments={'lmb':1, 'eps':1})
	assert ret is not None
...
def testMlpyKernelLearners():
	...
	trainingObj4d = Matrix(data4d,variables)

	data2d = [[0,1,1], [0,0,1], [0,3,2], [1,-300,2], [1,1,500]]
	trainingObj2d = Matrix(data2d,variables)

	data2 = [[2,3],[-200,0]]
	testObj = Matrix(data2)

	ret = UML.trainAndApply("mlpy.KFDA", trainingObj2d, trainY="Y", testX=testObj, output=None, arguments={'kernel':'KernelLinear'})
	assert ret is not None
	ret = UML.trainAndApply("mlpy.KFDAC", trainingObj2d, trainY="Y", testX=testObj, output=None, arguments={'kernel':'KernelPolynomial'})
	assert ret is not None
	ret = UML.trainAndApply("mlpy.KPCA", trainingObj4d, trainY="Y", testX=testObj, output=None, arguments={'kernel':'KernelGaussian'})
	assert ret is not None
	ret = UML.trainAndApply("mlpy.KernelRidge", trainingObj4d, trainY="Y", testX=testObj, output=None, arguments={'kernel':'KernelSigmoid'})
	assert ret is not None
	# 2 classes
	ret = UML.trainAndApply("mlpy.Parzen", trainingObj2d, trainY="Y", testX=testObj, output=None, arguments={'kernel':'KernelGaussian'})
	assert ret is not None
...
def testMlpyKernelExponentialDisallowed():
	...
	ret = UML.trainAndApply("mlpy.KFDA", trainingObj2d, trainY="Y", testX=testObj, output=None, arguments={'kernel':'KernelExponential'})
	assert ret is not None
