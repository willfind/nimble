...
def _testRegressorsHandmade():
    ...
    UML.trainAndApply("regressor.ConstantRegressor", trainingIn.name, trainY=2, testX=trialIn.name,
                      output=actualOut.name, arguments={'randomObject': None})
...
def _testRegressorsHandmadeTrainMatrix():
    ...
    UML.trainAndApply("regressor." + learnerName, training, trainY=2, testX=trialIn.name, output=actualOut.name,
                      arguments={})
