...
if __name__ == "__main__":
    ...
    toRun = 'trainAndTest("sciKitLearn.SGDClassifier", trainX, trainY, testX, testY, {"class_weight":{1:1.0, 2:<0.5|1.0|1.25|1.5|1.75|2.0|5.0|10.0>, "alpha":0.00001}, [fractionTrueNegativeTop90], scoreMode="allScores", negativeLabel="2", sendToLog=False)'
    ...
    # runNItersCombinations = 'trainAndTest("sciKitLearn.SGDClassifier", trainX, trainY, testX, testY, {"alpha":<0.0000001|0.000001|0.00001|0.0001|0.001|0.01|0.1|1.0>}, [fractionTrueNegativeTop90], scoreMode="allScores", negativeLabel="2", sendToLog=True)'
