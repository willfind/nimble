...
downtownMinAM = nimble.createData('Matrix', 'downtown_am_min.csv',
                                  featureNames=True)
downtownMaxAM = nimble.createData('Matrix', 'downtown_am_max.csv',
                                  featureNames=True)
downtownMinPM = nimble.createData('Matrix', 'downtown_pm_min.csv',
                                  featureNames=True)
downtownMaxPM = nimble.createData('Matrix', 'downtown_pm_max.csv',
                                  featureNames=True)
airportMinAM = nimble.createData('Matrix', 'airport_am_min.csv',
                                 featureNames=True)
airportMaxAM = nimble.createData('Matrix', 'airport_am_max.csv',
                                 featureNames=True)
airportMinPM = nimble.createData('Matrix', 'airport_pm_min.csv',
                                 featureNames=True)
airportMaxPM = nimble.createData('Matrix', 'airport_pm_max.csv',
                                 featureNames=True)
...
for obj in [downtownMinAM, downtownMaxAM, airportMinAM, airportMaxAM]:
    ...
    newFt = nimble.createData('Matrix', ftData, featureNames=['extreme'])
...
for obj in [downtownMinAM, airportMinAM]:
    ...
    newFt = nimble.createData('Matrix', stationData, featureNames=['station'])
    obj.features.insert(1, newFt)
